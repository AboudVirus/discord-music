  ...
  run: async (client, interaction) => {
    ...
    try {
      ...
      if (stp === "normal") {
        ...
        embed.setDescription(`>>> **- ${lang.msg138.replace('{channel}',`<#${client.config.messages.CID}>`)}**`)
        embed.setImage('https://dzlx.netlify.app/20230906061859863.gif')
        await interaction.reply({ content: lang.msg61 ,embeds:[embed]}).catch(e => { })
        try {
